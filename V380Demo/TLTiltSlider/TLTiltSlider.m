...
//    UIImage *knobImage = [UIImage imageNamed:@"thumImage.png"];
    [self setThumbImage:[UIImage imageNamed:@"thumImage.png"] forState:UIControlStateNormal];
    [self setThumbImage:[UIImage imageNamed:@"thumImageHighlight.png"] forState:UIControlStateSelected];
    [self setThumbImage:[UIImage imageNamed:@"thumImageHighlight.png"] forState:UIControlStateHighlighted];
